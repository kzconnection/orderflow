...
const Overlays = /* @__PURE__ */ Object.assign({
  ...
  "../scripts/Area.navy": __vite_glob_0_1,
  "../scripts/ArrowTrades.navy": __vite_glob_0_2,
  "../scripts/Band.navy": __vite_glob_0_3,
  "../scripts/Candles.navy": __vite_glob_0_4,
  "../scripts/CandlesPlus.navy": __vite_glob_0_5,
  "../scripts/Cloud.navy": __vite_glob_0_6,
  "../scripts/Histogram.navy": __vite_glob_0_7,
  "../scripts/PriceLabels.navy": __vite_glob_0_8,
  "../scripts/Range.navy": __vite_glob_0_9,
  "../scripts/Sparse.navy": __vite_glob_0_10,
  "../scripts/Spline.navy": __vite_glob_0_11,
  "../scripts/Splines.navy": __vite_glob_0_12,
  "../scripts/SuperBands.navy": __vite_glob_0_13,
  "../scripts/Trades.navy": __vite_glob_0_14,
...
class Input {
  ...
  async listeners() {
    const Hamster = await import("./hamster-e7735821.js").then((n) => n.h);
    const Hammer = await import("./hammer-3390a618.js").then((n) => n.h);
  ...
  zoomY(delta) {
    let interval = this.layout.$hi - this.layout.$lo;
    let k = interval / 1e3;
    let diff = delta * k / 0.8;
    let high = this.layout.$hi + diff;
    let low = this.layout.$lo - diff;
